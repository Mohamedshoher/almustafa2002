...
import { Camera, Save, Loader2, Coins, Wallet, ExternalLink, RefreshCw, CheckCircle2, Clock } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl space-y-6">
        ...
        <div className="pt-4">
          <label className="block font-black text-slate-800 text-xl mb-4 text-center md:text-right border-r-4 border-indigo-600 pr-3">تفاصيل المديونية</label>
